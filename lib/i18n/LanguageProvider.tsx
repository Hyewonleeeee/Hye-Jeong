...
const translations: Translations = {
  ko: {
    ...
    footer: "© 2025 Hye-Jeong. All rights reserved.",
    privacy: "개인정보처리방침",
    terms: "이용약관",
    step: "단계",
    step1Title: "나이 · 성별",
    ...
    selectNone: "선택안함",
    backToHome: "홈으로 돌아가기",
    calculatingStyle: "추구미 산출 중",
    loading: "로딩 중",
    yourStyleIs: "당신의 추구미는",
    recommendationLabel: "추천 향수",
  },
  en: {
    ...
    age40s: "40s",
    age50plus: "50+",
    selectNone: "Prefer not to say",
    backToHome: "Back to Home",
    calculatingStyle: "Calculating your style",
    loading: "Loading...",
    yourStyleIs: "Your style is",
  ...
  cn: {
    ...
    terms: "条款",
    backToHome: "返回首页",
    calculatingStyle: "正在计算您的风格",
    loading: "加载中...",
    yourStyleIs: "您的风格是",
    recommendationLabel: "推荐香水",
  },
  jp: {
    headline: "パーソナル香水テスト",
    ...
    terms: "利用規約",
    backToHome: "ホームに戻る",
    calculatingStyle: "あなたのスタイルを算出中",
    loading: "読み込み中...",
    yourStyleIs: "あなたのスタイルは",
    recommendationLabel: "おすすめ香水",
  },
};
